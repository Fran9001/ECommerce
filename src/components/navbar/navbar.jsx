        ...
        <div>
          ...
          <div className="dropdown">
            ...
            {isOpen && (
              <ul
                tabIndex={0}
                className="flex flex-row justify-start dropdown-content z-[1] menu p-2 shadow text-stone-900 bg-zinc-200 dark:bg-stone-700  rounded-box w-[96vw]"
              >
                <li className="w-[50%] md:w-1/5 mb-6 font-semibold dark:text-zinc-200 hover:text-stone-900 hover:bg-green-300 duration-300 rounded">
                  <a>Almacenamiento</a>
                </li>
                <li className="w-[50%] md:w-1/5 mb-6 font-semibold  dark:text-zinc-200 hover:text-stone-900 hover:bg-green-300 duration-300 rounded">
        ...
        <div className="flex-none hidden sm:inline-block">
          <div className="dropdown dropdown-end duration-300">
            ...
            {isOpen && (
              <ul
                tabIndex={0}
                className="menu menu-sm font-semibold dropdown-content z-[1] p-2 mt-1 shadow text-stone-900 bg-zinc-200 dark:bg-stone-700 dark:text-zinc-200 rounded-box w-52"
              >
        ...
        <div className="flex-none sm:hidden">
          <div className="dropdown dropdown-end duration-300">
            ...
            {isOpen && (
              <ul
                tabIndex={0}
                className="mt-1 menu menu-sm font-semibold dropdown-content z-[1] p-2 shadow text-stone-900 dark:text-zinc-200 bg-zinc-200 dark:bg-stone-700  rounded-box w-52"
              >
                <li className="mb-2 hover:text-stone-900 hover:bg-green-300 duration-300 rounded-lg">
                  <a>Inicio</a>
                </li>
